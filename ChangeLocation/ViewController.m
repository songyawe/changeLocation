...
- (void)viewDidLoad {
    ...
    //叶青北园   116.468369623421339,40.020832841140439
    //奥北中心北区  40.059262,116.409936
    //2.在进行坐标转换
    CLLocationCoordinate2D location2D = CLLocationCoordinate2DMake(116.468369623421339,40.020832841140439);
...
- (void)locationManager:(CLLocationManager *)manager didUpdateLocations:(NSArray<CLLocation *> *)locations {
    ...
    //3.去Location1.gpx修改经纬度
    //当前的经纬度
    NSLog(@"当前的经纬度 %.15f,%.15f",currentLocation.coordinate.latitude,currentLocation.coordinate.longitude);
